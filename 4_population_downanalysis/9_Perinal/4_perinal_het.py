...
LastEditors: Ne0tea
LastEditTime: 2025-04-18 20:17:24
'''
import pandas as pd
...
def draw_facegrid(plot_df):
    ...
    gs = fig.add_gridspec(nrows=2, ncols=3, height_ratios=[10, 1], hspace=0.2)
    ...
    plt.suptitle("", y=0.95)
    plt.savefig(r'E:\Bio_analysis\Weed_genome_project\Digitaria\Population\Perinal_analysis\Perinal_2013_2015_2023_E1_allele_freq.pdf', format='pdf')
    # plt.show()
